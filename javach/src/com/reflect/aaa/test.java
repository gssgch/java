...
public class test {
    ...
    */
    ...
    public static void main(String[] args) throws Exception {
        ...
        Class inte=Class.forName("com.reflect.inte1");
        System.out.println(inte);//结果是  interface com.reflect.inte1
        */

        Class c1 = Class.forName("com.reflect.stu");
        //Class是一个类，通过.forName(className)方法，创建了一个Class类的对象c1

        System.out.println("1:" + c1); //结果是class  com.reflect.stu
